...
public class WeatherService {
	...
	private List<WeatherDTO> getAPIData(Region regionInfo) throws Exception {
		...
		URI uri2 = createWeatherURI(baseDate, curDate, curTime);
	...
	private URI createAWSURI(String baseDate, String baseTime) throws UnsupportedEncodingException, URISyntaxException {
	...
	public URI createWeatherURI(String baseDate, String curDate, String curTime)
		...
		builder.append(
				"&" + URLEncoder.encode("obs", "UTF-8") + "=" + URLEncoder.encode("ta,hm,rn_60m,ta_chi", "UTF-8"));
		builder.append("&" + URLEncoder.encode("itv", "UTF-8") + "=" + URLEncoder.encode("1440", "UTF-8"));
	...
	public static List<WeatherDTO> parseWeatherData(String response, WeatherDTO curWeatherDTO) {
		// 응답에서 데이터 부분만 추출
